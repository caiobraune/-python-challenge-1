        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    order.append({"Item name": menu_selection_name, "Price":[menu_items]["Price"], "Quantity":number})
...
for item in order:
    ...
    num_quantity_spaces = 8 - len(str(number))
...
print(f"{item_name}{item_name_spaces}| ${price:.2f}{price_spaces} | {number}{quantity_spaces}")
